...
@section('title', 'Edit Holiday - Admin Dashboard')
...
<div class="space-y-6">
    <!-- Back Button -->
    <div>
        <a href="{{ route('admin.holidays.show', $holiday) }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700">
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Edit Holiday: {{ $holiday->name }}</h3>
            <p class="mt-1 text-sm text-gray-500">Update holiday information and settings</p>
        </div>
            ...
            <div class="px-6 py-4 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   name="date" 
                                   id="date" 
                                   value="{{ old('date', isset($holiday->date) ? \Carbon\Carbon::parse($holiday->date)->format('Y-m-d') : '') }}"
                                   required
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="sort_order" 
                                   id="sort_order" 
                                   value="{{ old('sort_order', $holiday->sort_order ?? 0) }}"
                                   min="0"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" 
                                      ...
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-300 @enderror">{{ old('description', $holiday->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('placement_days_before', $holiday->placement_days_before ?? 1) }}"
                                   required
                                   min="0"
                                   max="30"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('removal_days_after', $holiday->removal_days_after ?? 1) }}"
                                   required
                                   min="0"
                                   max="30"
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" 
                                       ...
                                       id="active" 
                                       value="1"
                                       {{ old('active', $holiday->active) ? 'checked' : '' }}
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input type="checkbox" 
                                       ...
                                       id="recurring" 
                                       value="1"
                                       {{ old('recurring', $holiday->recurring ?? true) ? 'checked' : '' }}
                                       class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                            </div>
                            <div class="ml-3">
                ...
                <div class="pt-6 border-t border-gray-200">
                    <div class="text-sm text-gray-500">
                        <p><strong>Created:</strong> {{ $holiday->created_at->format('F j, Y g:i A') }}</p>
                        <p><strong>Last Updated:</strong> {{ $holiday->updated_at->format('F j, Y g:i A') }}</p>
                    </div>
                </div>
            </div>
