...
<div class="space-y-6">
    <!-- Back Button -->
    <div>
        <a href="{{ route('admin.customers.show', $customer) }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700">
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-medium text-gray-900">Edit Customer: {{ $customer->name }}</h3>
            <p class="mt-1 text-sm text-gray-500">Update customer information and account details</p>
        </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        Changing the address will automatically check if the customer is within a service area.
                                    </p>
                                </div>
                            </div>
                        </div>
