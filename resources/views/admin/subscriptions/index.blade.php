...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <p class="text-sm text-gray-500">Manage customer subscriptions and billing</p>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-2xl font-semibold text-indigo-600">${{ number_format($stats['total_revenue'], 2) }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-2xl font-semibold text-purple-600">${{ number_format($stats['monthly_revenue'], 2) }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                @forelse($subscriptions as $subscription)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $subscription->flagProduct->display_name ?? 'N/A' }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            @php
                                $statusColors = [
